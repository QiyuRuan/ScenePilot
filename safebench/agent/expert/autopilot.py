...
from safebench.agent.expert.utils import draw_route, inverse_conversion_2d
...
class AutoPilot(object):
    def __init__(self, config=None, logger=None):
        ...
        self.logger = logger
        self.step = -1
        # Align with FREA style: target speed comes from shared CarlaDataProvider.
        ...
        self.ignore_traffic_lights = True  # for frea: whether to ignore traffic lights
