...
class CarlaDataProvider(object): 
    ...
    _ego_desired_speed = 6.0  # for autopilot (m/s)
    ...
    def set_ego_desired_speed(ego_desired_speed):
        """
            Set desired ego cruising speed (for autopilot).
        """
        CarlaDataProvider._ego_desired_speed = float(ego_desired_speed)

    @staticmethod
    def get_ego_desired_speed():
        """
            Get desired ego cruising speed (for autopilot).
        """
