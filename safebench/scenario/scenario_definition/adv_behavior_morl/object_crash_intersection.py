...
class VehicleTurningRoute(BasicScenario):
    ...
    def _get_crossing_point(self, actor):
        ...
        # ★ Hotfix: move forward out of the intersection shadow near the start point.
        ahead = wp_cross.next(2.0)          # Adjust from 5 m to 6-8 m if needed.
        if ahead: wp_cross = ahead[0]
