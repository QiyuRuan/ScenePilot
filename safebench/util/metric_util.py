...
# Original SafeBench eval metric where lower scenario collision yields lower score.
...
def parse_args():
    ...
    parser.add_argument('--record_file', default='output/testing_records/record.pkl')
